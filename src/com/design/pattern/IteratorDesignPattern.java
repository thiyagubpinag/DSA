...
public class IteratorDesignPattern {
    ...
    // Library class
    static class Library implements Iterable<Book> {
    ...
    static class LibraryIterator implements Iterator<Book> {
    ...
    static class LibraryAuthorIterable implements Iterable<Book> {
        private List<Book> books;
    ...
    static class LibraryYearIterable implements Iterable<Book> {
        private List<Book> books;
