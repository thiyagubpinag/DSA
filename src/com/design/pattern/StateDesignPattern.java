...
public class StateDesignPattern {
    ...
    public static class ProcessingOrderState implements OrderState {
        @Override
        public void nextState(Order order) {
    ...
    public static class ShippedOrderState implements OrderState {
        @Override
        public void nextState(Order order) {
    ...
    public static class DeliveredOrderState implements OrderState {
        @Override
        public void nextState(Order order) {
